...
| `gitnexus`                                                                                                                              | `gitnexus.status`, `gitnexus.query`, `gitnexus.context`, `gitnexus.impact`, `gitnexus.detect-changes`, `gitnexus.build`, `gitnexus.rename`, `gitnexus.cypher` | Registered              | Manifest-backed family. Space aliases such as `gitnexus status` resolve to the same handlers. |
